...
namespace Gameplay
{
    public class Packet : IDisposable
    {
        ...
        public Packet Write(ISerializable obj)
        {
            obj.ToPacket(this);
            return this;
        }

        public Packet Write<T>(IEnumerable<T> list) where T : ISerializable
        {
        ...
        public AAction ReadAction(GameController controller)
        {
